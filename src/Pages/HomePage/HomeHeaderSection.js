    ...
    return (
        <header className="grid grid-rows-2 items-center justify-items-center p-4 lg:grid-cols-2 lg:grid-rows-1 lg:gap-y-8 lg:gap-x-8 lg:pt-24">
            <div className="lg:justify-self-end">
                ...
                >
                    <img src={Desktop} alt="RoghaniCar.com" title="روغنی کار | فروش محصولات روغن و فیلتر خودرو" />
                </motion.div>
                <motion.div
                ...
                >
                    <img src={Phone} alt="RoghaniCar.com" title="روغنی کار | فروش محصولات روغن و فیلتر خودرو" />
                </motion.div>
            </div>
            <div className="flex w-full flex-col items-center gap-y-2 justify-self-start lg:mr-20 lg:mt-20 lg:w-[25rem] lg:self-start">
                <div className="w-fit lg:self-start">
                    <h1 className="text-[27px] font-thin text-orange-500">به آسانی چند کلیک؛</h1>
                ...
                <div className="max-w-sm lg:self-start">
                    ...
                    <p className="mt-3 font-extrabold text-slate-500">یادت نره قبل از خرید، قیمتامون رو مقایسه کنی</p>
                </div>
                <div
                    className="
                ...
                >
                    ...
                    <Link to="/products" className="order-1 flex w-full flex-col items-center">
                        <div
                            className="
